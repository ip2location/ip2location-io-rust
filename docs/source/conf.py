...
project = 'IP2Location.io Rust SDK'
...
myst_html_meta = {
    "description": "IP2Location.io Rust library allows user to query for an enriched data set based on IP address and provides WHOIS lookup api that helps users to obtain domain information.",
    "keywords": "IP2Location, Geolocation, IP location, Rust, WHOIS, domain, hosted domain",
...
html_title = "IP2Location.io Rust SDK"

html_baseurl = "https://ip2location-io-rust.readthedocs.io/en/latest/"